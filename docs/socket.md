...
| Key                                                            | Value                                                                                                                |
| -------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| データをサーバーへJSON形式で渡して、記憶させる方法を知っておく | 📖[DjangoでデータをサーバーへJSON形式で渡して、記憶させよう！](https://qiita.com/muzudho1/items/ed0ea262aaa327a2d12b) |
...
# Step 1. main_finally.py ファイルを作成
...
📄`host_local1/sockapp1/main_finally.py`:  
...
📄`host_local1/sockapp1/echo_server.py`:  
...
📄`host_local1/sockapp1/client.py`:  
